...
void        wtCompute( float2* in_waveform_ft, float2* out_wavelet_ft, float sampleRate, float minHz, float maxHz, cudaExtent numElem, unsigned half_sizes, float scales_per_octave, float sigma_t0, cudaStream_t stream=0 );
