        ...
        showEvent(QShowEvent *)
{
    ...
    ui->labelSystem->setText(QString(
            ...
            "Cuda runtime version: %12\n")
                             ...
                             .arg(DataStorageVoid::getMemorySizeText( CudaProperties::gpu_memory_speed(), 1 ).c_str())
                             .arg(DataStorageVoid::getMemorySizeText( CpuProperties::cpu_memory_speed(), 1 ).c_str())
