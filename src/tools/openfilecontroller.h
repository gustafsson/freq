...
public:
    ...
    public:
        ...
        virtual Signal::OperationDesc::ptr reopen(QString url, Signal::OperationDesc::ptr) = 0;
    };
    ...
    Signal::OperationDesc::ptr open(QString url) { return reopen(url, Signal::OperationDesc::ptr()); }
