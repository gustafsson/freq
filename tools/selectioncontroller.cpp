...
namespace Tools
{
            ...
            setupGui()
    {
        ...
        connect(ui->actionActionAdd_selection, SIGNAL(toggled(bool)), SLOT(receiveAddSelection(bool)));
        connect(ui->actionActionRemove_selection, SIGNAL(toggled(bool)), SLOT(receiveAddClearSelection(bool)));
