...
*1. Username*
Send your public ssh-key to sonicawe@muchdifferent.com, se 2.5
...
Then send your public public ssh-key to sonicawe@muchdifferernt.com.
...
<pre>$ git clone ssh://git@jovia.net:2232/sonic.git
-- If you are asked a password at this point, use "git"
$ cd sonic
